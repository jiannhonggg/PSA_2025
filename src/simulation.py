...
class Simulation:
    ...
    def __init__(self):
        ...
        input_df = pd.read_csv("data/input.csv", header=0).head(
            CONSTANT.JOB_PARAMETER.TOTAL_NUMBER_OF_JOBS
        )
    ...
    def export_terminal_statistics(self) -> Dict[str, Dict[str, int]]:
        ...
        # jobs
        number_of_total_jobs = CONSTANT.JOB_PARAMETER.TOTAL_NUMBER_OF_JOBS
